...
if __name__ == "__main__":
    ...
    def get_xbox(par):
        ...
        return HPacker(children=boxes, align="center", pad=0, sep=10 if small else 1)
    xbox = HPacker(children=[get_xbox(par) for par in pars], align="center", pad=0, sep=55 if small else 35)
    anchored_xbox = AnchoredOffsetbox(loc=3, child=xbox, pad=0, frameon=False,
                                      bbox_to_anchor=(0.08 if small else 0.05, -0.05),
