...
if __name__ == "__main__":
    ...
    parser.add_argument('--estimated_CNN_large', type=str, help="estimated parameters")
    parser.add_argument('--estimated_FFNN_large', type=str, help="estimated parameters")
    ...
    for (label, csv) in zip(('CNN-large', 'FFNN-large', 'CNN', 'FFNN'),
